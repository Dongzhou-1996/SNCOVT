...
import trackers.KCF.fhog as fhog
...
class KCFTracker:
    ...
    def createHanningMats(self):
        ...
        # plt.axis('off')
        # plt.savefig(
        #     'C:\\Users\\dongz\\Desktop\\Near Earth Asteroids Tracking by Ground Simulation\\bare_jrnl\\imgs\\kcf\\hanning_window.png',
        #     dpi=600)
        # plt.show()
    ...
    def createGaussianPeak(self, sizey, sizex):
        ...
        y, x = (y - syh) ** 2, (x - sxh) ** 2
        res = np.exp(mult * (y + x))
        # plt.figure('expect output')
        # plt.imshow(res)
        # plt.axis('off')
        # plt.savefig(
        #     'C:\\Users\\dongz\\Desktop\\Near Earth Asteroids Tracking by Ground Simulation\\bare_jrnl\\imgs\\kcf\\expect_output.png',
        #             dpi=600)
    ...
    def getFeatures(self, image, inithann, scale_adjust=1.0):
        ...
        if (self._hogfeatures):
            ...
            # FeaturesMap2 = mapp['map'].reshape((self.size_patch[0], self.size_patch[1],
            #                                    -1))
            # plt.figure('feature map')
            # plt.imshow(FeaturesMap2[:, :, 1])
            # plt.axis('off')
            # # plt.savefig(
            # #     'C:\\Users\\dongz\\Desktop\\Near Earth Asteroids Tracking by Ground Simulation\\bare_jrnl\\imgs\\kcf\\feature_map.png',
            # #     dpi=600)
            # plt.show()
        else:
    ...
    def detect(self, z, x):
        ...
        # plt.figure('similarity map')
        # plt.imshow(res)
        # plt.axis('off')
        # plt.savefig(
        #     'C:\\Users\\dongz\\Desktop\\Near Earth Asteroids Tracking by Ground Simulation\\bare_jrnl\\imgs\\kcf\\similarity_map.png',
        #     dpi=600)
        # plt.show()
        # cv2.namedWindow('similarity map', cv2.WINDOW_GUI_EXPANDED)
        # cv2.imshow('similarity map', res)
    ...
    def train(self, x, train_interp_factor):
        ...
        correlation_filter_img = cv2.magnitude(self._alphaf[:, :, 0], self._alphaf[:, :, 1])
        # cv2.normalize(correlation_filter_img, correlation_filter_img, alpha=1, beta=0, norm_type=cv2.NORM_MINMAX)
        # plt.figure('feature map')
        # plt.imshow(correlation_filter_img)
        # plt.axis('off')
        # plt.savefig(
        #     'C:\\Users\\dongz\\Desktop\\Near Earth Asteroids Tracking by Ground Simulation\\bare_jrnl\\imgs\\kcf\\correlation_filter.png',
        #     dpi=600)
        # plt.show()
